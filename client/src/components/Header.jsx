      ...
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <p className="text-1xl text-gray-500 font-semibold">
            You can organize, track, and complete your assignments efficiently.
          </p>
        </div>
        <button className="text-1xl font-semibold flex items-center justify-center gap-1 text-red-600 py-2 px-4 border border-2 border-red-600 rounded-3xl">
          <IoIosAdd size={20} />
          Add Task
        </button>
      </div>
